...
rm -rf /rsrch5/scratch/epi/${user}/GTEx_v8/temp/${tissue}
rm -rf /rsrch5/scratch/epi/${user}/GTEx_v8/raw/${tissue}
rm -rf /rsrch5/scratch/epi/${user}/GTEx_v8/reports/${tissue}
rm -rf /rsrch5/scratch/epi/${user}/GTEx_v8/metrics/${tissue}
rm -rf /rsrch5/scratch/epi/${user}/GTEx_v8/align/${tissue}
rm -rf /rsrch5/scratch/epi/${user}/GTEx_v8/quant/${tissue}
